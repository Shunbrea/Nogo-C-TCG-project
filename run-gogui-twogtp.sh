...
#P1B='./nogo --shell --name="My-Black" --black="search=zero"'
#P1W='./nogo --shell --name="My-White" --white="search=zero"'
...
P2B='gogui-client 140.113.167.34 5566'
P2W='gogui-client 140.113.167.34 5566'
